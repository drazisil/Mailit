...
public class MetaItemFactory implements ItemFactory {

    private final ItemFactory parentFactory;

    public MetaItemFactory() {
        this.parentFactory = plugin.getServer().getItemFactory();
    }
